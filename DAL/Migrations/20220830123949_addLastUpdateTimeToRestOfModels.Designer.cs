...
namespace DAL.Migrations
{
    ...
    [Migration("20220830123949_addLastUpdateTimeToRestOfModels")]
    partial class addLastUpdateTimeToRestOfModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.VM", b =>
                {
                    b.Property<int>("VMID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DAL.Models.Vpn", b =>
                {
            ...
            modelBuilder.Entity("DAL.Models.VM", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Lun", "Lun")
                        .WithMany()
                        .HasForeignKey("LunID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Models.Node", "Node")
                        .WithMany()
